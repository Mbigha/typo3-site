...
call_user_func(
    function()
    {
        ...
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_hofbootcamp_domain_model_student', 'EXT:hof_bootcamp/Resources/Private/Language/locallang_csh_tx_hofbootcamp_domain_model_student.xlf');
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_hofbootcamp_domain_model_student');

        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_hofbootcamp_domain_model_participant', 'EXT:hof_bootcamp/Resources/Private/Language/locallang_csh_tx_hofbootcamp_domain_model_participant.xlf');
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_hofbootcamp_domain_model_participant');
