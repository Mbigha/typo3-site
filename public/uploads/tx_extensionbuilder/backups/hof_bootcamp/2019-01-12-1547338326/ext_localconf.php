...
call_user_func(
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig(
        'mod {
            wizards.newContentElement.wizardItems.plugins {
                elements {
                    ...
                    speakerdetails {
                        iconIdentifier = hof_bootcamp-plugin-speakerdetails
                        title = LLL:EXT:hof_bootcamp/Resources/Private/Language/locallang_db.xlf:tx_hof_bootcamp_speakerdetails.name
                        description = LLL:EXT:hof_bootcamp/Resources/Private/Language/locallang_db.xlf:tx_hof_bootcamp_speakerdetails.description
                        tt_content_defValues {
                            CType = list
                            list_type = hofbootcamp_speakerdetails
                        }
                    }
                    sessiondetail {
		...
		$iconRegistry = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\TYPO3\CMS\Core\Imaging\IconRegistry::class);
			...
			$iconRegistry->registerIcon(
				'hof_bootcamp-plugin-speakerdetails',
				\TYPO3\CMS\Core\Imaging\IconProvider\SvgIconProvider::class,
				['source' => 'EXT:hof_bootcamp/Resources/Public/Icons/user_plugin_speakerdetails.svg']
			);
