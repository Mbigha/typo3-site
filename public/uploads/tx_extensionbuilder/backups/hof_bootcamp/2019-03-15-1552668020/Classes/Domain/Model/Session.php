...
class Session extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * Removes a Student
     * 
     * @param  $studentToRemove The  to be removed
     * @return void
     */
     ...
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<> students
     */
     ...
     * Sets the students
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<> $students
     * @return void
     */
