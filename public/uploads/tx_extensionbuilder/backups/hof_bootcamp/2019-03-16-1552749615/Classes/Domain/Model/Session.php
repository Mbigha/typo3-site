...
class Session extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * A Session can have many speakers and a speaker can speak in one or many sessions
     * 
     * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\HofBootCamp\HofBootcamp\Domain\Model\Participant>
     */
    ...
    /**
     * Returns the numberOfRegistrations
     * 
     * @return string $numberOfRegistrations
     */
    ...
    /**
     * Sets the numberOfRegistrations
     * 
     * @param string $numberOfRegistrations
     * @return void
     */
     ...
     * @return void
     */
    public function addParticipant(\HofBootCamp\HofBootcamp\Domain\Model\Participant $participant)
    {
     ...
     * 
     * @param \HofBootCamp\HofBootcamp\Domain\Model\Participant $participantToRemove The Participant to be removed
     * @return void
     */
    public function removeParticipant(\HofBootCamp\HofBootcamp\Domain\Model\Participant $participantToRemove)
    {
     ...
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\HofBootCamp\HofBootcamp\Domain\Model\Participant> $participants
     */
     ...
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\HofBootCamp\HofBootcamp\Domain\Model\Participant> $participants
     * @return void
     */
