...
class SessionTest extends \TYPO3\TestingFramework\Core\Unit\UnitTestCase
{
     ...
     * @test
     */
    public function getNumberOfRegistrationsReturnsInitialValueForString()
    {
        self::assertSame(
            '',
            $this->subject->getNumberOfRegistrations()
        );
    }
     ...
     * @test
     */
    public function setNumberOfRegistrationsForStringSetsNumberOfRegistrations()
    {
        $this->subject->setNumberOfRegistrations('Conceived at T3CON10');
