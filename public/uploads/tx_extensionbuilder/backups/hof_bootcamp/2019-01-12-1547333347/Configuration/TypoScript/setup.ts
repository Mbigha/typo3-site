...
plugin.tx_hofbootcamp_speakerdetail {
    view {
        templateRootPaths.0 = EXT:hof_bootcamp/Resources/Private/Templates/
        templateRootPaths.1 = {$plugin.tx_hofbootcamp_speakerdetail.view.templateRootPath}
        partialRootPaths.0 = EXT:hof_bootcamp/Resources/Private/Partials/
        partialRootPaths.1 = {$plugin.tx_hofbootcamp_speakerdetail.view.partialRootPath}
        layoutRootPaths.0 = EXT:hof_bootcamp/Resources/Private/Layouts/
        layoutRootPaths.1 = {$plugin.tx_hofbootcamp_speakerdetail.view.layoutRootPath}
    }
    persistence {
        storagePid = {$plugin.tx_hofbootcamp_speakerdetail.persistence.storagePid}
        #recursive = 1
    }
    features {
        #skipDefaultArguments = 1
...
plugin.tx_hofbootcamp_location {
    view {
        templateRootPaths.0 = EXT:hof_bootcamp/Resources/Private/Templates/
        templateRootPaths.1 = {$plugin.tx_hofbootcamp_location.view.templateRootPath}
        partialRootPaths.0 = EXT:hof_bootcamp/Resources/Private/Partials/
        partialRootPaths.1 = {$plugin.tx_hofbootcamp_location.view.partialRootPath}
        layoutRootPaths.0 = EXT:hof_bootcamp/Resources/Private/Layouts/
        layoutRootPaths.1 = {$plugin.tx_hofbootcamp_location.view.layoutRootPath}
    }
    persistence {
        storagePid = {$plugin.tx_hofbootcamp_location.persistence.storagePid}
        #recursive = 1
    }
    features {
        #skipDefaultArguments = 1
